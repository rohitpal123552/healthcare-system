...
class Patient(Base):
    ...
    patient_uuid = Column(String(36), unique=True, default=lambda: str(uuid.uuid4()))
...
class MedicalRecord(Base):
    """
    The Encounter model. Links patient + appointment + doctor and owns prescriptions & billing.
    """
    ...
    billing = relationship("Billing", back_populates="record", cascade="all, delete-orphan")
...
class Billing(Base):
    ...
    record = relationship("MedicalRecord", back_populates="billing")
